package co.teakjjo.prj.papago.web;
...
public class PapagoController {
	...
	@RequestMapping(value="/papagoTranslation.do", produces="application/text;charset=utf8" )
	@ResponseBody
	public String papagoTranslation(@RequestParam(value = "word")String word, @RequestParam(value = "language")String language) {
		String clientId = "CKv2coNAzQHKd1P3TtCC";//애플리케이션 클라이언트 아이디값";
        String clientSecret = "Qp6oxWh7Md";//애플리케이션 클라이언트 시크릿값";
