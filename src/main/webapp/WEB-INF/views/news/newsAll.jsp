        ...
        <div class="row d-flex" id="newsAll">
          ...
          <c:forEach items="${newsList }" var="news">
              		...
              		<div class="text">
                		...
                		<h6 class="heading" style="font-size:1vw"><a href="newsDetail.do?no=${news.newsboard_title }&newsboard_id=${news.newsboard_id}" onclick="hitUpdate(`${news.newsboard_title }`)" id="newsboard_title">${news.newsboard_title }</a></h6>
                		<div class="meta mb-3">
